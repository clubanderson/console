...
export const DEFAULT_PRIMARY_NAV: SidebarItem[] = [
  ...
  { id: 'acmm', name: 'ACMM', icon: NAVIGATION_ICONS['acmm'], href: '/acmm', type: 'link', order: 5.5 },
  { id: 'ci-cd', name: 'CI/CD', icon: NAVIGATION_ICONS['ci-cd'], href: '/ci-cd', type: 'link', order: 6 },
