...
const DIFFICULTY_CONFIG = {
  beginner: { label: 'Beginner', color: 'text-green-700 dark:text-green-400 bg-green-100 dark:bg-green-950', stars: 1 },
  intermediate: { label: 'Intermediate', color: 'text-yellow-700 dark:text-yellow-400 bg-yellow-100 dark:bg-yellow-950', stars: 2 },
  advanced: { label: 'Advanced', color: 'text-red-700 dark:text-red-400 bg-red-100 dark:bg-red-950', stars: 3 } } as const
