    ...
    return (
      <div>
        <div className="relative">
          ...
          <pre className="p-4 rounded-lg bg-secondary/50 dark:bg-black/50 border border-border overflow-auto max-h-[60vh] text-xs text-foreground font-mono whitespace-pre-wrap">
