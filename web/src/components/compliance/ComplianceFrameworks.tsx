...
function ControlAccordion({ control }: { control: ControlResult }) {
  ...
  return (
    <div className="border border-border rounded-lg overflow-hidden">
      <button
        className="w-full flex items-center gap-3 px-4 py-3 bg-secondary/70 hover:bg-secondary transition-colors text-left"
        onClick={() => setOpen(v => !v)}
        type="button"
      >
      ...
      {selectedFw && (
        <div className="flex items-center gap-4 p-4 rounded-lg border border-border bg-card">
          ...
          <button
            ...
            className="px-4 py-1.5 bg-blue-600 hover:bg-blue-500 disabled:bg-secondary disabled:text-muted-foreground text-foreground text-sm font-medium rounded-md transition-colors flex items-center gap-2"
            type="button"
          >
