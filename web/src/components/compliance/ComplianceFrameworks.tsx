  ...
  return (
    <div className="relative inline-flex items-center justify-center w-28 h-28">
      <svg className="transform -rotate-90" width={80} height={80}>
        <circle cx={40} cy={40} r={r} className="stroke-border" strokeWidth={6} fill="none" />
        <circle
          cx={40} cy={40} r={r}
          stroke="currentColor"
          strokeWidth={6}
...
function CheckRow({ check }: { check: ComplianceCheck }) {
  return (
    <div className="flex items-start gap-3 py-2 px-3 rounded-md bg-card/50 hover:bg-secondary/50 transition-colors">
...
function ControlAccordion({ control }: { control: ControlResult }) {
  ...
  return (
    <div className="border border-border rounded-lg overflow-hidden">
      <button
        className="w-full flex items-center gap-3 px-4 py-3 bg-card/70 hover:bg-secondary/50 transition-colors text-left"
        onClick={() => setOpen(v => !v)}
        type="button"
      >
      ...
      {open && (
        <div className="px-4 py-2 space-y-1.5 bg-secondary/50">
...
export const ComplianceFrameworksContent = memo(function ComplianceFrameworksContent() {
  ...
  return (
    <div className="p-6 space-y-6 max-w-7xl mx-auto">
      ...
      {/* Evaluate bar */}
      {selectedFw && (
        <div className="flex items-center gap-4 p-4 rounded-lg border border-border bg-card/60">
          ...
          <button
            ...
            className="px-4 py-1.5 bg-blue-600 hover:bg-blue-500 disabled:bg-muted disabled:text-muted-foreground text-white text-sm font-medium rounded-md transition-colors flex items-center gap-2"
            type="button"
          >
      ...
      {result && (
        <div className="space-y-6">
          {/* Score summary */}
          <div className="flex items-center gap-8 p-6 rounded-lg border border-border bg-card/60">
