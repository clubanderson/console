...
const githubLight: Theme = {
  ...
  colors: {
    ...
    glassShadow: 'rgba(9, 105, 218, 0.12)',
    scrollbarThumb: 'rgba(9, 105, 218, 0.25)',
    scrollbarThumbHover: 'rgba(9, 105, 218, 0.45)',
